...
#define FIH_TRUE_1 (0x300Au)
#define FIH_TRUE_2 (0x0C50u)
#define FIH_TRUE ((int32_t)(0x3C5AU)) /* i.e., FIH_TRUE_1 | FIH_TRUE_2 */
#define FIH_FALSE ((int32_t)(0xA5C3u))

#define FIH_POSITIVE_VALUE ((int32_t)(0x5555AAAAu))
#define FIH_NEGATIVE_VALUE ((int32_t)(0xAAAA5555u))
...
#define FIH_INT_INIT(x)                                                        \
  { (x), (int32_t)((uint32_t)(x) ^ FIH_MASK_VALUE) }
...
typedef volatile fih_int_ret fih_int;
typedef volatile fih_uint_ret fih_uint;

#define FIH_UINT_INIT(x)                                                       \
  { (x), (x) ^ FIH_UINT_MASK_VALUE }
 ...
 */
typedef int32_t fih_int_ret;
typedef uint32_t fih_uint_ret;
typedef volatile fih_int_ret fih_int;
typedef volatile fih_uint_ret fih_uint;
...
#define FIH_SUCCESS ((fih_uint_ret)FIH_INT_INIT(FIH_POSITIVE_VALUE))
#define FIH_FAILURE ((fih_uint_ret)FIH_INT_INIT(FIH_NEGATIVE_VALUE))
#define FIH_UINT_ZERO ((fih_uint_ret)FIH_UINT_INIT(0u))
#define FIH_UINT_MAX ((fih_uint_ret)FIH_UINT_INIT(0xFFFFFFFFu))
 ...
 */
__attribute__((noinline)) __attribute__((noreturn)) void fih_panic_loop(void);
 ...
 */
__attribute__((always_inline)) static inline bool fih_delay(void) {
  uint32_t i = 0;
 ...
 */
__attribute__((always_inline)) static inline void fih_int_validate(fih_int x) {
  int32_t x_msk = x.msk;

  if (x.val != (int32_t)(x_msk ^ FIH_MASK_VALUE)) {
    FIH_PANIC;
  }
}
...
fih_uint_validate(fih_uint x) {
  uint32_t x_msk = x.msk;

  if (x.val != (x_msk ^ FIH_UINT_MASK_VALUE)) {
    FIH_PANIC;
  }
  return true;
}
 ...
 */
__attribute__((always_inline)) static inline int32_t fih_int_decode(fih_int x) {
  fih_int_validate(x);
  return x.val;
}
 ...
 */
__attribute__((always_inline)) static inline fih_int_ret
fih_int_encode(int32_t x) {
  fih_int ret = {x, (int32_t)(x ^ FIH_MASK_VALUE)};
  return ret;
}
 ...
 */
__attribute__((always_inline)) static inline fih_uint_ret
fih_uint_encode(uint32_t x) {
  fih_uint ret = {x, x ^ FIH_UINT_MASK_VALUE};
  return ret;
}
 ...
 */
__attribute__((always_inline)) static inline int32_t fih_eq(fih_int x,
                                                            fih_int y) {
  int32_t y_val, y_msk;
...
#define fih_uint_eq(x, y)                                                      \
  (fih_uint_validate(x) && fih_uint_validate(y) && ((x).val == (y).val) &&     \
   fih_delay() && ((x).msk == (y).msk) && fih_delay() &&                       \
 ...
 */
__attribute__((always_inline)) static inline int32_t fih_not_eq(fih_int x,
                                                                fih_int y) {
  int32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
...
fih_uint_not_eq(fih_uint x, fih_uint y) {
 ...
 * @return   FIH_TRUE if x > y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_gt(fih_int x,
                                                            fih_int y) {
  int32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
  ...
  y_msk = y.msk;
  if ((int32_t)(x.msk ^ FIH_MASK_VALUE) > (int32_t)(y_msk ^ FIH_MASK_VALUE)) {
    rc |= (int32_t)FIH_TRUE_2;
  }
 ...
 * @return   FIH_TRUE if x > y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_uint_gt(fih_uint x,
                                                                 fih_uint y) {
  uint32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
  ...
  y_msk = y.msk;
  if ((x.msk ^ FIH_UINT_MASK_VALUE) > (y_msk ^ FIH_UINT_MASK_VALUE)) {
    rc |= (int32_t)FIH_TRUE_2;
  }
 ...
 * @return   FIH_TRUE if x >= y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_ge(fih_int x,
                                                            fih_int y) {
  int32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
 ...
 * @return   FIH_TRUE if x >= y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_uint_ge(fih_uint x,
                                                                 fih_uint y) {
  uint32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
 ...
 * @return   FIH_TRUE if x < y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_lt(fih_int x,
                                                            fih_int y) {
  int32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
 ...
 * @return   FIH_TRUE if x < y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_uint_lt(fih_uint x,
                                                                 fih_uint y) {
  uint32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
 ...
 * @return   FIH_TRUE if x <= y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_le(fih_int x,
                                                            fih_int y) {
  int32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
 ...
 * @return   FIH_TRUE if x <= y, FIH_FALSE otherwise.
 */
__attribute__((always_inline)) static inline int32_t fih_uint_le(fih_uint x,
                                                                 fih_uint y) {
  uint32_t y_val, y_msk;
  volatile int32_t rc = FIH_FALSE;
 ...
 */
__attribute__((always_inline)) static inline fih_uint_ret
fih_uint_or(fih_uint x, fih_uint y) {
  uint32_t y_val, y_msk;
  volatile fih_uint_ret rc = {0};
  ...
  y_msk = y.msk;
  rc.msk = ((x.msk ^ FIH_UINT_MASK_VALUE) | (y_msk ^ FIH_UINT_MASK_VALUE)) ^
           FIH_UINT_MASK_VALUE;
 ...
 */
__attribute__((always_inline)) static inline fih_uint_ret
fih_uint_and(fih_uint x, fih_uint y) {
  uint32_t y_val, y_msk;
  volatile fih_uint_ret rc = {0};
...
int32_t fih_not_eq(fih_int x, fih_int y)
{
           ...
           */
          __attribute__((always_inline)) static inline int32_t
          fih_uint_gt(fih_uint x, fih_uint y) {
            volatile int32_t rc = FIH_FALSE;
           ...
           */
          __attribute__((always_inline)) static inline int32_t
          fih_uint_ge(fih_uint x, fih_uint y) {
            volatile int32_t rc = FIH_FALSE;
           ...
           */
          __attribute__((always_inline)) static inline int32_t
          fih_uint_lt(fih_uint x, fih_uint y) {
            volatile int32_t rc = FIH_FALSE;
           ...
           */
          __attribute__((always_inline)) static inline int32_t
          fih_uint_le(fih_uint x, fih_uint y) {
            volatile int32_t rc = FIH_FALSE;
...
/**
 * C has a common return pattern where 0 is a correct value and all
 * others are errors.  This function converts 0 to FIH_SUCCESS, and
 * any other number to a value that is not FIH_SUCCESS.
 *
...
/**
 * Increment the CFI counter by input counter and return the value
 * before the increment. NOTE: this function shall not be called
 * directly.
 *
...
/**
 * Validate that the saved precall value is the same as the value of
 * the global counter. For this to be the case, a fih_ret must have
 * been called between these functions being executed. If the values
 * aren't the same then panic. NOTE: this function shall not be called
 * directly.
 *
...
/**
 * Decrement the global CFI counter by one, so that it has the same
 * value as before the cfi_precall. NOTE: this function shall not be
 * called directly.
 */
void fih_cfi_decrement(void);

/*
 * Macro wrappers for functions - Even when the functions have zero
 * body this saves a few bytes on noop functions as it doesn't
 * generate the call/ret
 *
 * CFI precall function saves the CFI counter and then increments it -
 * the postcall then checks if the counter is equal to the saved
 * value. In order for this to be the case a FIH_RET must have been
 * performed inside the called function in order to decrement the
 * counter, so the function must have been called.
 */
#define FIH_CFI_PRECALL_BLOCK                                                  \
  fih_uint fih_cfi_precall_saved_value = fih_cfi_get_and_increment(1u)

#define FIH_CFI_POSTCALL_BLOCK fih_cfi_validate(fih_cfi_precall_saved_value)

#define FIH_CFI_PRERET fih_cfi_decrement()

/*
 * Marcos to support protect the control flow integrity inside a
 * function.
 *
 * The FIH_CFI_PRECALL_BLOCK/FIH_CFI_POSTCALL_BLOCK pair mainly
 * protect function calls from fault injection. Fault injection may
 * attack a function to skip its critical steps which are not function
 * calls. It is difficult for the caller to dectect the injection as
 * long as the function successfully returns.
 *
 * The following macros can be called in a function to track the
 * critical steps, especially those which are not function calls.
 */

/*
 * FIH_CFI_STEP_INIT() saves the CFI counter and increase the CFI
 * counter by the number of the critical steps. It should be called
...
/*
 * FIH_CFI_STEP_DECREMENT() decrease the CFI counter by one. It can be
 * called after each critical step execution completes.
 */
#define FIH_CFI_STEP_DECREMENT() fih_cfi_decrement()

/*
 * FIH_CFI_STEP_ERR_RESET() resets the CFI counter to the previous
 * value saved by FIH_CFI_STEP_INIT(). It shall be called only when a
 * functionality error occurs and forces the function to exit. It can
 * enable the caller to capture the functionality error other than
 * being trapped in fault injection error handling.
 */
...
/*
 * Label for interacting with FIH testing tool. Can be parsed from the
 * elf file after compilation. Does not require debug symbols.
 */
#define FIH_LABEL(str) __asm volatile("FIH_LABEL_" str "_0_%=:" ::)
#define FIH_LABEL_CRITICAL_POINT() FIH_LABEL("FIH_CRITICAL_POINT")

/*
 * Main FIH calling macro. return variable is second argument. Does
 * some setup before and validation afterwards. Inserts labels for use
 * with testing script.
 *
 * First perform the precall step - this gets the current value of the
 * CFI counter and saves it to a local variable, and then increments
 * the counter.
 *
 * Then set the return variable to FIH_FAILURE as a base case.
 *
 * Then perform the function call. As part of the function FIH_RET
 * must be called which will decrement the counter.
 *
 * The postcall step gets the value of the counter and compares it to
 * the previously saved value. If this is equal then the function call
 * and all child function calls were performed.
 */
 ...
 * NOTE: intended use is bit masks, so initialized by 0 instead of
 * FIH_FAILURE!
 */
...
/*
 * FIH return changes the state of the internal state machine. If you
 * do a FIH_CALL then you need to do a FIH_RET else the state machine
 * will detect tampering and panic.
 */
#define FIH_RET(ret)                                                           \
  do {                                                                         \
    FIH_CFI_PRERET;                                                            \
...
typedef fih_int_ret fih_int;
typedef fih_uint_ret fih_uint;
...
#define FIH_UINT_ZERO (0u)
#define FIH_UINT_MAX (0xFFFFFFFFu)
