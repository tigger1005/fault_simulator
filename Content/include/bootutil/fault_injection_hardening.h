...
#define FIH_INT_INIT(x)         {(x), (int32_t)((uint32_t)(x) ^ FIH_MASK_VALUE)}
...
#define FIH_UINT_INIT(x)        {(x), (x) ^ FIH_UINT_MASK_VALUE}
...
#define FIH_SUCCESS     ((fih_int_ret)FIH_INT_INIT(FIH_POSITIVE_VALUE))
#define FIH_FAILURE     ((fih_int_ret)FIH_INT_INIT(FIH_NEGATIVE_VALUE))
 ...
 */
__attribute__((always_inline)) static inline
fih_int_ret fih_int_encode(int32_t x)
{
 ...
 */
__attribute__((always_inline)) static inline
fih_uint_ret fih_uint_encode(uint32_t x)
{
 ...
 */
__attribute__((always_inline)) static inline
fih_uint_ret fih_uint_or(fih_uint x, fih_uint y)
{
    uint32_t y_val, y_msk;
    ...
    y_msk = y.msk;
    rc.msk = ((x.msk ^ FIH_UINT_MASK_VALUE) | (y_msk ^ FIH_UINT_MASK_VALUE)) ^ FIH_UINT_MASK_VALUE;
 ...
 */
__attribute__((always_inline)) static inline
fih_uint_ret fih_uint_and(fih_uint x, fih_uint y)
{
    uint32_t y_val, y_msk;
    volatile fih_uint_ret rc = {0};
 ...
 */
__attribute__((always_inline)) static inline
fih_int_ret fih_int_encode_zero_equality(int32_t x)
{
    if (x != 0) {
        return FIH_FAILURE;
    } else {
